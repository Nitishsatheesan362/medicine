...
CREATE TABLE `ehospital` (
  ...
  `hcontact` varchar(255) NOT NULL,

  PRIMARY KEY (`hcontact`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ehospital`
--

INSERT INTO `ehospital` (`hname`, `haddress`, `hcontact`) VALUES
('Bansal Hospital', 'Bansal Hospital C - Sector Shahpura Bhopal M.P. 462016 India', '6467732788'),
('Paliwal Hospital', 'Plot No 1, Hoshangabad Road, Bhopal - 462022, Near ISBT Bus Stand', '8275459378'),
('Apollo Sage Hospital', 'New market TT Nagar Zone 1 Bhopal M.P 462016 India', '9267732758'),
('Roshan Hospital', 'Plot No 32 Apsara Road  Bhopal 462022 Near Subhash Nagar', '9675459378');
